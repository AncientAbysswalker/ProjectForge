class u {
  ...
  static debounce(fn, wait, id) {
    if (u.isUndefined(window.mapPage_debounceIds)) {
      window.mapPage_debounceIds = {};
    }
    clearTimeout(window.mapPage_debounceIds[id]);
    window.debounceIds = {};
    window.mapPage_debounceIds[id] = setTimeout(fn, wait);
  }
